...
class EpsilonGreedyPolicy(Policy):
    ...
    def next(self):
        ...
        if rand_val < self.epsilon:
            picked_move = random.randint(0, 3)
        else:
            picked_move = highest_move_index
...
def create_epsilon_greedy_policy(world, epsilon):
    ...
    goal_pos = [treasure_a, treasure_b]  # middle
...
def create_map():
    ...
    num_cols = 10
    num_rows = 10
    grid = [['o' for col in range(num_cols)]
            for row in range(num_rows)]
    ...
    grid[treasure_a][treasure_a] = GridWorld.goal_rep

    # Monsters
    grid[4][5] = GridWorld.bad_rep
    grid[4][6] = GridWorld.bad_rep
    grid[5][6] = GridWorld.bad_rep
    grid[5][8] = GridWorld.bad_rep
    grid[6][8] = GridWorld.bad_rep
    grid[7][3] = GridWorld.bad_rep
    grid[7][5] = GridWorld.bad_rep
    grid[7][6] = GridWorld.bad_rep

    # Agent
    grid[0][0] = GridWorld.pos_rep
